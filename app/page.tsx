...
export default function Home() {
  return (
    <main className='flex w-full flex-col items-center justify-center bg-zinc-950 px-4 md:px-20'>
      <div className='container pt-10 flex flex-col items-center justify-center text-center sm:py-20 md:max-w-5xl md:pt-32'>
      ...
      <div className='flex  h-full w-full flex-col md:max-w-6xl'>
        <Blog />
      </div>
    </main>
  )
